...
;; [paal adaptation] (scheme cxr) and (scheme char) added to the import:
;; the file uses caddr and string-ci=? without importing them, which
;; kaappi's unenforced import scope tolerates and paal's conformance
;; check rejects.
(import (scheme base) (scheme write) (scheme char) (scheme cxr) (scheme process-context) (srfi 64)
        (prefix (srfi 13) s13:)
