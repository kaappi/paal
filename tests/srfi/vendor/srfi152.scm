...
;; [paal adaptation] (scheme char) added to the import: the file uses
;; char-alphabetic? without importing it, which kaappi's unenforced import
;; scope tolerates and paal's conformance check rejects.
(import (scheme base) (scheme char) (srfi 152) (scheme process-context) (srfi 64))
