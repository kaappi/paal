...
;; make-rectangular without importing it, which kaappi's unenforced
;; import scope tolerates and paal's conformance check rejects.
(import (scheme complex)
        (except (scheme base) equal?) (scheme process-context) (srfi 64) (srfi 63))
