...
;; [paal adaptation] (scheme eval) (scheme repl) added to the import: the file uses
;; eval without importing it, which kaappi's unenforced import
;; scope tolerates and paal's conformance check rejects.
(import (scheme eval) (scheme repl)
        (scheme base) (scheme process-context) (srfi 188) (srfi 64))
