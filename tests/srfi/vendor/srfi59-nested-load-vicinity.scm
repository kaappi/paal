...
;; [paal adaptation] (scheme load) added to the import: the file calls
;; load without importing it, which kaappi's unenforced import scope
;; tolerates and paal's conformance check rejects.
(import (scheme load)
        (scheme base) (scheme process-context) (srfi 64) (srfi 59))
