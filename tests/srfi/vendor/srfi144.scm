...
;; [paal adaptation] (scheme inexact) added to the import: the file uses
;; nan? without importing it, which kaappi's unenforced import
;; scope tolerates and paal's conformance check rejects.
(import (scheme inexact)
        (scheme base) (srfi 144) (scheme process-context) (srfi 64))
