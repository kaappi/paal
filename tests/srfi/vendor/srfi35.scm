...
;; [paal adaptation] (scheme write) added to the import: the file calls
;; display without importing it, which kaappi's unenforced import
;; scope tolerates and paal's conformance check rejects.
(import (scheme write)
        (scheme base) (scheme process-context) (srfi 35))
