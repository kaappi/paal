...
;; [paal adaptation] (scheme cxr) added to the import: the file uses
;; caddr without importing it, which kaappi's unenforced import
;; scope tolerates and paal's conformance check rejects.
(import (scheme cxr)
        (scheme base) (scheme write) (scheme process-context) (srfi 64) (srfi 178))
