...
;; [paal adaptation] (scheme complex) added to the import: the file uses
;; make-rectangular without importing it, which kaappi's unenforced import
;; scope tolerates and paal's conformance check rejects.
(import (scheme complex)
        (scheme base) (scheme process-context) (srfi 64) (srfi 231 storage-classes))
