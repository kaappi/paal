...
;; [paal adaptation] (scheme process-context) added to the import: the file calls
;; exit without importing it, which kaappi's unenforced import
;; scope tolerates and paal's conformance check rejects.
(import (scheme process-context)
        (scheme base) (scheme char) (scheme write) (srfi 13))
