...
;;; [paal adaptation] (srfi 13)'s string-replace added to the import:
;;; the library calls it without importing it — kaappi answers it as a
;;; builtin, paal only through (srfi 13).  `only` keeps the rest of
;;; that library out of this one's scope.
